...
const FUNCTION_NAME: string = 'GetNFTCollection';

export class GetNFTCollectionLambda extends LambdaFunction {
  constructor(scope: ConstructWithAppScope) {
    const GET_NFT_COLLECTION_PROPS: lambda.FunctionProps = {
    ...
    super(scope, GET_NFT_COLLECTION_PROPS);
  };
};
